...
if exist C:\Users\devcloud\inkling-autolab\bin\full-cache-recency.exe exit /b 1
...
if errorlevel 1 exit /b %errorlevel%
if exist C:\Users\devcloud\inkling-autolab\bin\full-cache-recency.exe exit /b 1
copy C:\Users\devcloud\inkling-autolab\target\release\examples\inkling_decode_bench.exe C:\Users\devcloud\inkling-autolab\bin\full-cache-recency.exe
if errorlevel 1 exit /b %errorlevel%
exit /b 0
