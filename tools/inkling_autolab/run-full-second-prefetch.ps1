...
if (($ReuseBuffers -or $SkipBulkPrefetch) -and $Binary -notin @('full-read-buffers.exe', 'full-owned-shared.exe', 'full-uncached.exe', 'full-pipeline.exe', 'full-expert-cache.exe', 'full-prefill-reads.exe', 'full-cache-decay.exe', 'full-cache-recency.exe', 'full-route-prediction.exe', 'full-predicted-read.exe', 'full-early-prediction.exe', 'full-early-prefetch.exe', 'full-second-prefetch.exe')) { throw 'Select a qualified read-buffer binary for reusable read options' }
if ($OwnShared -and $Binary -notin @('full-owned-shared.exe', 'full-uncached.exe', 'full-pipeline.exe', 'full-expert-cache.exe', 'full-prefill-reads.exe', 'full-cache-decay.exe', 'full-cache-recency.exe', 'full-route-prediction.exe', 'full-predicted-read.exe', 'full-early-prediction.exe', 'full-early-prefetch.exe', 'full-second-prefetch.exe')) { throw 'Select a qualified owned-shared binary' }
if ($UncachedReads -and ($Binary -notin @('full-uncached.exe', 'full-pipeline.exe', 'full-expert-cache.exe', 'full-prefill-reads.exe', 'full-cache-decay.exe', 'full-cache-recency.exe', 'full-route-prediction.exe', 'full-predicted-read.exe', 'full-early-prediction.exe', 'full-early-prefetch.exe', 'full-second-prefetch.exe') -or !$ReuseBuffers -or $Reads)) { throw 'Uncached reads require a qualified binary, ReuseBuffers1 and Reads0' }
if ($PipelineReads -and ($Binary -notin @('full-pipeline.exe', 'full-expert-cache.exe', 'full-prefill-reads.exe', 'full-cache-decay.exe', 'full-cache-recency.exe', 'full-route-prediction.exe', 'full-predicted-read.exe', 'full-early-prediction.exe', 'full-early-prefetch.exe', 'full-second-prefetch.exe') -or !$ReuseBuffers -or $Reads)) { throw 'Pipelined reads require qualified full-pipeline.exe, ReuseBuffers1 and Reads0' }
if ($ExpertCacheMiB -and ($Binary -notin @('full-expert-cache.exe', 'full-prefill-reads.exe', 'full-cache-decay.exe', 'full-cache-recency.exe', 'full-route-prediction.exe', 'full-predicted-read.exe', 'full-early-prediction.exe', 'full-early-prefetch.exe', 'full-second-prefetch.exe') -or !$PipelineReads -or !$ReuseBuffers -or $Reads)) { throw 'Expert caching requires qualified full-expert-cache.exe, PipelineReads1, ReuseBuffers1 and Reads0' }
if ($PrefillReads -and ($Binary -notin @('full-prefill-reads.exe', 'full-cache-decay.exe', 'full-cache-recency.exe', 'full-route-prediction.exe', 'full-predicted-read.exe', 'full-early-prediction.exe', 'full-early-prefetch.exe', 'full-second-prefetch.exe') -or !$ReuseBuffers -or $Reads)) { throw 'Prefill reads require qualified full-prefill-reads.exe, ReuseBuffers1 and Reads0' }
if ($CacheResetHistory -and ($Binary -notin @('full-prefill-reads.exe', 'full-cache-decay.exe', 'full-cache-recency.exe', 'full-route-prediction.exe', 'full-predicted-read.exe', 'full-early-prediction.exe', 'full-early-prefetch.exe', 'full-second-prefetch.exe') -or !$ExpertCacheMiB)) { throw 'Cache history reset requires qualified full-prefill-reads.exe and a nonzero expert cache budget' }
if ($CacheDecayRequests -ne 4096 -and ($Binary -notin @('full-cache-decay.exe', 'full-cache-recency.exe', 'full-route-prediction.exe', 'full-predicted-read.exe', 'full-early-prediction.exe', 'full-early-prefetch.exe', 'full-second-prefetch.exe') -or !$ExpertCacheMiB)) { throw 'Short cache decay requires qualified full-cache-decay.exe and a nonzero expert cache budget' }
if ($CacheRecentTies -and ($Binary -notin @('full-cache-recency.exe', 'full-route-prediction.exe', 'full-predicted-read.exe', 'full-early-prediction.exe', 'full-early-prefetch.exe', 'full-second-prefetch.exe') -or !$ExpertCacheMiB)) { throw 'Recent-tie admission requires qualified full-cache-recency.exe and a nonzero expert cache budget' }
if ($PredictionTrace -and ($Binary -notin @('full-route-prediction.exe', 'full-predicted-read.exe', 'full-early-prediction.exe', 'full-early-prefetch.exe', 'full-second-prefetch.exe') -or !$RouteTrace)) { throw 'Prediction diagnostics require qualified full-route-prediction.exe and an actual RouteTrace' }
if ($PredictReads -and ($Binary -notin @('full-predicted-read.exe', 'full-early-prediction.exe', 'full-early-prefetch.exe', 'full-second-prefetch.exe') -or !$ExpertCacheMiB -or !$PipelineReads -or !$ReuseBuffers -or $Reads)) { throw 'Predicted reads require qualified full-predicted-read.exe and a nonzero pipelined expert cache' }
if ($PredictionLeadLayers -and ($Binary -notin @('full-early-prediction.exe', 'full-early-prefetch.exe', 'full-second-prefetch.exe') -or !$PredictionTrace)) { throw 'One-layer-early diagnostics require qualified full-early-prediction.exe and PredictionTrace' }
if ($EarlyPredictReads -and ($Binary -notin @('full-early-prefetch.exe', 'full-second-prefetch.exe') -or !$PredictReads)) { throw 'Early prefetch requires qualified full-early-prefetch.exe and PredictReads1' }
if ($SecondPredictReads -and ($Binary -ne 'full-second-prefetch.exe' -or !$PredictReads -or $EarlyPredictReads)) { throw 'Selective second prefetch requires qualified full-second-prefetch.exe, PredictReads1 and EarlyPredictReads0' }
