...
* **cli,sparse-moe:** expert-parallel roles — --ep-workers driver, --ep-worker-index/--ep-worker-count worker ([55cf2af](https://github.com/labscommunity/cascadia/commit/55cf2af6b2a596300093ceed65b7757e268da81a))
* **engine:** log prefill/decode split and decode tok/s for single-stage tasks ([7721d29](https://github.com/labscommunity/cascadia/commit/7721d29a67a06bebac7b1596c6bce883a385a665))
* **glm:** count prefill-stream enqueues; assert streaming engaged ([2d3502c](https://github.com/labscommunity/cascadia/commit/2d3502c20896c7c3c5f63bb0aa82a7c065a5e835))
* **glm:** log the resolved prefill-stream mode at load ([f9b2ceb](https://github.com/labscommunity/cascadia/commit/f9b2ceb57f6edb07d4cdf774f2dc28530a831493))
* **glm:** note when prefill streaming stands down (non-mmap / narrow batch) ([49b46cb](https://github.com/labscommunity/cascadia/commit/49b46cbacd34d3a3b355bd900a30b430a64a4031))
* **glm:** warn when the residency probe is dead on the gated prefill path ([5132089](https://github.com/labscommunity/cascadia/commit/51320896c1bebed55c03c76828610648b914ee77))
* **inkling:** add fused iGPU expert routing and full-model topology validation ([69156c7](https://github.com/labscommunity/cascadia/commit/69156c7113a8fa6f80deea9c8b512b5a233549b3))
* **inkling:** CASCADIA_INKLING_PIN_EXPERTS wires the export in RAM ([a802be0](https://github.com/labscommunity/cascadia/commit/a802be0b82b3c870d57052d5137d3f9207c3b81a))
* **inkling:** compile fused-MoE IRs from materialised constants by default ([138b3e7](https://github.com/labscommunity/cascadia/commit/138b3e7305b22d6b20c2da6e118f01baa7603b6a))
* **inkling:** fused-MoE IRs padded past the 1% offload floor; warm-up sweeps every expert ([1f83761](https://github.com/labscommunity/cascadia/commit/1f837616737d2638f773be3ee0ecf82b06df6e6e))
* **inkling:** int8 attention-projection variant and a selectable attention IR directory ([0bc5d73](https://github.com/labscommunity/cascadia/commit/0bc5d73b195166a7878e85b41b5e31c6c8f53708))
* **inkling:** Intel iGPU backends (per-expert, fused MoE, int8 attention, head) + single-box bench: CPU 1.10 / iGPU 1.24 / OpenVINO-native 0.59 tok/s ([2966063](https://github.com/labscommunity/cascadia/commit/29660633050a8746a9d6be3f1c362d640f838f45))
* **inkling:** OpenVINO attention-projection backend (int4 projections on the iGPU) ([dc0402c](https://github.com/labscommunity/cascadia/commit/dc0402ce655cfc5c97a845c34139be41cbfefef9))
* **inkling:** OpenVINO expert backend (iGPU / NPU / CPU) ([0060cde](https://github.com/labscommunity/cascadia/commit/0060cdee55fa26900b3f3259b58cf3024b6dca46))
* **inkling:** OpenVINO fused-MoE backend (one compiled model per layer) ([e07612c](https://github.com/labscommunity/cascadia/commit/e07612c997298bb6f9964146160e3f1fcfdf76ff))
* **inkling:** OpenVINO head backend (int8 unembed on the iGPU) ([aee59a3](https://github.com/labscommunity/cascadia/commit/aee59a39081b755b576cd515b9cb9e77e5e0ac90))
* **inkling:** require and qualify iGPU expert routing ([f2fc6b3](https://github.com/labscommunity/cascadia/commit/f2fc6b36524327029cbb6539508ee7394d055ea7))
* **inkling:** route expert replicas across capacity-checked workers ([fee798e](https://github.com/labscommunity/cascadia/commit/fee798efbf9d61a89e7d27a1a79ee74fef960d27))
* **sparse-moe:** expert-parallel dispatch for the Inkling family (driver + expert workers) ([d7ff932](https://github.com/labscommunity/cascadia/commit/d7ff932e77b3ab116939d428cb9936c7c71f17ae))
* **sparse-moe:** Inkling (Thinking Machines 975B MoE) family ([d203638](https://github.com/labscommunity/cascadia/commit/d203638739fcbbdd27bfa997279c2baa26d1c211))
* **sparse-moe:** Inkling family compute core (GQA + relative-position bias + short convs, MoE) ([802a4a4](https://github.com/labscommunity/cascadia/commit/802a4a4d4975580794cb061c1d30dc186d23473a))
* **sparse-moe:** Inkling loader, stage runner, and engine arm ([e854029](https://github.com/labscommunity/cascadia/commit/e854029fc7679b0e3b82be0529d2a8508b588a0c))
* **tools:** Inkling exporter, HF-oracle fixtures, and reference tooling ([723b9e5](https://github.com/labscommunity/cascadia/commit/723b9e53566ab7cfa9c9b1f01f729abb48398d29))


### Bug Fixes

* **api:** effort-dialect probe, Inkling marker translation, tojson indent+separators guard ([07486ad](https://github.com/labscommunity/cascadia/commit/07486adffcd7e1c455997892922e90a4d4c0bbaf))
* **api:** reasoning_effort probe logs when it can't render ([a85fd00](https://github.com/labscommunity/cascadia/commit/a85fd00c9341bb0ba3502bd766cbf14a4c1c614c))
* **api:** the caller's reasoning_effort word reaches templates with their own scale ([095d28d](https://github.com/labscommunity/cascadia/commit/095d28d9b690b80b51069672d272993b799925b5))
* **api:** warn when a marker-framed template's ids can't be resolved ([d98db03](https://github.com/labscommunity/cascadia/commit/d98db039312428b4bd8281ee5f63dc63e958465f))
* **cli:** name the gemma4 engine in the post-shard run hint ([94cdd0c](https://github.com/labscommunity/cascadia/commit/94cdd0c001ff64f183d126e51c4852a46d88cf48))
* **deps:** bump rustls to 0.23.45 for RUSTSEC-2026-0285 ([5166085](https://github.com/labscommunity/cascadia/commit/516608511fdde815a78d6ec4680408c21cd34d67))
* **export:** find config.json in the HF hub cache offline and say when detection was skipped ([06801c7](https://github.com/labscommunity/cascadia/commit/06801c7c22ca0f3598e4d33d315d1c8bc07a44e3))
* **gemma4-export:** check layer_types length against num_hidden_layers ([00f4940](https://github.com/labscommunity/cascadia/commit/00f494043c1ad97ae338e7851ae5df62b3f21ef5))
* **gemma4-export:** fail the export when self-verify fails ([a8188c1](https://github.com/labscommunity/cascadia/commit/a8188c1df65ed1b76e01b52b39063e17af75930a))
* **gemma4-export:** guard the window, record it in metadata, test the layer path ([bd81719](https://github.com/labscommunity/cascadia/commit/bd81719c157a407120710ab8938528aeeb1daa45))
* **gemma4-export:** mask sliding_attention layers to their window ([8e790ec](https://github.com/labscommunity/cascadia/commit/8e790ecab68813fc1c30ba9aad25b5b548d80d9b))
* **gemma4-export:** mask sliding_attention layers to their window ([466c73d](https://github.com/labscommunity/cascadia/commit/466c73d63f50849a0cd963312829cf9e3c4b8966))
* **gemma4-export:** narrow the sliding_window resolver error paths ([ecf5257](https://github.com/labscommunity/cascadia/commit/ecf52572e5f905b1395a5f4a0ac3f40390a8e9c1))
* **gemma4-export:** refuse a --stage re-export across export versions ([24b20b1](https://github.com/labscommunity/cascadia/commit/24b20b153ff79345f32b7689860baad3ae741435))
* **gemma4-export:** review follow-ups — config-first window, hoisted mask, verify past the window, warn on v1 trees ([1a23a97](https://github.com/labscommunity/cascadia/commit/1a23a970586ba40636b1d977fe7d6ba93335ba08))
* **gemma4-export:** trim the layer_types length error to what the operator needs ([8d4390d](https://github.com/labscommunity/cascadia/commit/8d4390dddc7cc52dbbc4b76c3355ef8dc0a48502))
* **gemma4:** carry prompt_tokens, finish_reason and the token count on the final chunk ([af1350f](https://github.com/labscommunity/cascadia/commit/af1350f7ffe795190e5677ef1dec94b049bb06ed))
* **gemma4:** count every interim token, not only those with text ([bf1e16f](https://github.com/labscommunity/cascadia/commit/bf1e16f9b5c2fa6a3234abc8213eaffa57651fab))
* **gemma4:** surface the pre-v1.1 warning on the load stream, once ([2346240](https://github.com/labscommunity/cascadia/commit/2346240c3448d68b8c452ca5f3a7f35f7cc6923e))
* **glm5_run:** guard --force/--ids args and empty logits ([bd184e6](https://github.com/labscommunity/cascadia/commit/bd184e60b18ef376e27134959579d6e9d1c48769))
* **glm:** hot/cold cold-read spawn failure falls back instead of panicking ([e1a5ee1](https://github.com/labscommunity/cascadia/commit/e1a5ee11752be5a2433194aa3570916374cb7188))
* **glm:** make hot/cold cold-read fallbacks observable ([ea8cfab](https://github.com/labscommunity/cascadia/commit/ea8cfabe00ab5b5e18e6512047ffc95c28c9d451))
* **glm:** read_bytes returns Err on a short read instead of panicking ([28f8073](https://github.com/labscommunity/cascadia/commit/28f80734cdae4832ef03e05d7f8c2da1ead3a0a3))
* **glm:** warn once when the residency probe is unavailable in Probe mode ([d7dffa4](https://github.com/labscommunity/cascadia/commit/d7dffa4524f629687e6d6ec007d0aa5e03d96678))
* **inkling:** attach the per-expert OpenVINO backend only to layers that ship IRs ([0946116](https://github.com/labscommunity/cascadia/commit/09461164635e325346b6fcc9ab23378a9f8057fd))
* **inkling:** cap retained expert read buffers on the direct EP path ([cdb7674](https://github.com/labscommunity/cascadia/commit/cdb7674a7859a560a95f0e84102f6f8bb51391ff))
* **inkling:** compile fused-MoE IRs through the plugin's offload path (ratio 1 by default) ([d74f9a9](https://github.com/labscommunity/cascadia/commit/d74f9a912b83e403098c524c1be8b69fbcec5128))
* **inkling:** correct fused row-chunk range in the error message ([e2dee66](https://github.com/labscommunity/cascadia/commit/e2dee660ca4b415b19ee1a930f537f52aa337a49))
* **inkling:** count and log swallowed expert-read I/O failures ([0a50f6f](https://github.com/labscommunity/cascadia/commit/0a50f6f45557132c980ac7f6694eaa3a40de0fb7))
* **inkling:** decline out-of-range expert ids in ExpertCache::retain ([e318c9b](https://github.com/labscommunity/cascadia/commit/e318c9b54972c867a9d5e4aa95a601fe3a849659))
* **inkling:** decode bench certifies OV backends actually ran (no silent fallback) ([cd9a996](https://github.com/labscommunity/cascadia/commit/cd9a996a22a9995ae1dd1cac951c1a37622962fa))
* **inkling:** do not deny unknown fields on FusedShardManifest ([b4f8395](https://github.com/labscommunity/cascadia/commit/b4f83952e42aef606117621a8e8d2fbb0d59d3dc))
* **inkling:** fused-MoE K mismatch fails loud instead of silent bypass ([125a8f5](https://github.com/labscommunity/cascadia/commit/125a8f5311105dbb061057b0f776aebe3801a17d))
* **inkling:** log when a prediction reader fails to spawn or dies ([e523bd9](https://github.com/labscommunity/cascadia/commit/e523bd9c365c2914ec775ba46a117b540b6d85db))
* **inkling:** make ov_expert device-call failures visible in benchmarks ([4326de3](https://github.com/labscommunity/cascadia/commit/4326de359654e978c5b8d9c757c8385b581b0dcf))
* **inkling:** no blob cache for materialised fused-MoE layers (an imported blob re-streams weights from the file) ([a4b453f](https://github.com/labscommunity/cascadia/commit/a4b453f2297e75565b0bd6d3140ff3e93da01045))
* **inkling:** ov_attn validates OV output length before use ([30b7684](https://github.com/labscommunity/cascadia/commit/30b76846265bb3cc57d6c67303b1a74e5ff93046))
* **inkling:** reject unknown keys in FusedShardManifest ([26a9586](https://github.com/labscommunity/cascadia/commit/26a95868112018c3d7c82f92a722518b2377c35d))
* **inkling:** report a fused-MoE compile failure on stderr; no per-expert warm-up on fused layers ([7c1ff05](https://github.com/labscommunity/cascadia/commit/7c1ff05c71c023e558573c86d6e1d7510180486b))
* **inkling:** report the first failing fused-MoE call per layer ([8821151](https://github.com/labscommunity/cascadia/commit/8821151cc8d66115e751cc44e8d8d348d6197bc7))
* **inkling:** set the plugin's decode-path knob in the C runtime environment on Windows ([e0dbeae](https://github.com/labscommunity/cascadia/commit/e0dbeaeccaea8577b6e9ec0fe9fa97c5a43acdc1))
* **inkling:** surface the first silent GPU-&gt;CPU expert fallback ([99b8742](https://github.com/labscommunity/cascadia/commit/99b87424475b0ce405a4fbf71d22281827df69bc))
* **inkling:** warm-up sweep does not count toward fused-MoE call statistics ([7b0b039](https://github.com/labscommunity/cascadia/commit/7b0b039823cb7c8466fb3039ed650b882bdb500c))
* **sparse-moe:** guard the driver warmup forward against a dead worker ([eae4249](https://github.com/labscommunity/cascadia/commit/eae4249f84154fc68f512602ec6f1d33f4fe3a26))
* **sparse-moe:** Inkling engine review fixes (rewind high-water mark, overlapped expert reads, strict manifest) ([56aadd3](https://github.com/labscommunity/cascadia/commit/56aadd335bd9ad0a537f2b3e1f4470674055abdf))
* **sparse-moe:** single-stage pipeline path emits per-token chunks with ids ([5f32344](https://github.com/labscommunity/cascadia/commit/5f323445bec458bc300442d9e3c3c7f98a1282ed))
* **tools:** export_inkling direct writes, --tiny guard; load-bearing relpos fixtures ([c9983c3](https://github.com/labscommunity/cascadia/commit/c9983c30116647b2aff0304d89cb61e7e5a1f0f9))
* **tools:** export_inkling streams per tensor (stage, then assemble) ([ad95f33](https://github.com/labscommunity/cascadia/commit/ad95f33dd78142385f7061a6b1256b5a7d781dc2))
* **tools:** export_inkling warns/strict-fails on absent load-bearing keys ([e597451](https://github.com/labscommunity/cascadia/commit/e5974519cfb90f931ed108d40c8dc692d28d8f2d))


### Performance

* **glm:** hot/cold overlapped expert reads — FreeToken-style bandwidth split for NVMe-streaming decode ([963f6c2](https://github.com/labscommunity/cascadia/commit/963f6c2d790a576e4b126e28aeb916492df86e28))
* **glm:** hot/cold overlapped expert reads (CASCADIA_GLM5_HOTCOLD) ([b663790](https://github.com/labscommunity/cascadia/commit/b6637906f17d1521cfd81c6518b1877c4db1f0fb))
* **glm:** row threshold for gated prefill streaming ([6b02202](https://github.com/labscommunity/cascadia/commit/6b02202a20b571f37627403666b5449e3f234609))
* **glm:** stream next layer's expert set during batched prefill — FreeToken-style prefill overlap ([df9bdac](https://github.com/labscommunity/cascadia/commit/df9bdac8ff731a92669dd91849f7c4231ec2d626))
* **glm:** stream next layer's expert set during batched prefill (CASCADIA_GLM5_PREFILL_STREAM) ([e20c733](https://github.com/labscommunity/cascadia/commit/e20c733759f2a1ade39813540e5d94bdac0d32ed))
* **inkling:** allow up to 1024 MiB/layer expert cache ([2e722fd](https://github.com/labscommunity/cascadia/commit/2e722fdb3ede8bac72f54bcc53d9ba6c663a170e))
* **inkling:** bucket device-call row counts (2, 8..32, then 32s) and warm the small buckets ([d2d4ee2](https://github.com/labscommunity/cascadia/commit/d2d4ee22930ddf61b9ab209ee3e9a6b42c78bea6))
* **inkling:** copy an expert's bin only when it is paged out ([edf4366](https://github.com/labscommunity/cascadia/commit/edf4366995b263b27714d871f9d4d0ad822bff45))
* **inkling:** extract CPU prerequisites for GPU and expert routing ([dd5155b](https://github.com/labscommunity/cascadia/commit/dd5155bac8efcf6d7c75545b2098d63e42d30305))
* **inkling:** fused-MoE warm-up issues one decode-shaped call so timed calls skip the kernel setup ([e64b23e](https://github.com/labscommunity/cascadia/commit/e64b23e39a20edd71ed0957b793059430bdb1365))
* **inkling:** qualify expert routing across three LAN NUCs ([7913658](https://github.com/labscommunity/cascadia/commit/791365890f6ea8590d8f2923267db4b279845cc2))
* **inkling:** release Rust attention copies served by OpenVINO; fused-MoE layer filter ([f1bebc3](https://github.com/labscommunity/cascadia/commit/f1bebc311428aec90f0858cad66903c34bfafb65))
* **inkling:** run a token's selected experts concurrently ([e2a4f31](https://github.com/labscommunity/cascadia/commit/e2a4f3171558ffb2b9a2df11c5480d6cc1376104))
* **sparse-moe:** size the rayon pool to the physical cores by default ([13f2c5b](https://github.com/labscommunity/cascadia/commit/13f2c5b41b3a0f66f0ac1c4c578095b1c6350b21))


### Refactor

* **gemma4-export:** drop the redundant int fast path in the window check ([64d49b3](https://github.com/labscommunity/cascadia/commit/64d49b34c5116fc101137b20991478013f1d2380))
* **inkling:** private shape fields + accessors on ShortConv/RelPos/AttentionLayer ([807b859](https://github.com/labscommunity/cascadia/commit/807b859bfbd06f47d84f98d79ddc49a5862aa004))
* **sparse-moe:** share arch peek, tokenizer load and max_seq parsing across the Rust-shell arms ([4a05552](https://github.com/labscommunity/cascadia/commit/4a05552b9ffba12330c7774cea24d33abe7d984f))


### Documentation

* drop non-existent CLI flags from the Inkling page; README lists the Rust-shell MoE families ([2e8b2a1](https://github.com/labscommunity/cascadia/commit/2e8b2a10114bfb9339cc7ea6d82cbd7520329da0))
* expert-parallel flags and topology for Inkling ([64fece1](https://github.com/labscommunity/cascadia/commit/64fece190b3ef58d0323c18ac8d9ba2e7b51520e))
* **gemma4-export:** correct the sliding-window comments and docstrings ([864cdaf](https://github.com/labscommunity/cascadia/commit/864cdaf1e25ed1a8450ea8bf6822109a174eaa96))
* **gemma4-export:** the per-layer override machinery lands in transformers 5.14, not 5.5 ([358016d](https://github.com/labscommunity/cascadia/commit/358016dc23689241e7d11806ac4f040512d9bc12))
* **gemma4:** correct two overbroad claims about export_version ([e6ec1d3](https://github.com/labscommunity/cascadia/commit/e6ec1d34590cd0331ed68fb4e159d24732379517))
* **gemma4:** give the re-export requirement a command ([c40470b](https://github.com/labscommunity/cascadia/commit/c40470bb4162d76cdaf952c03e50c701b100496c))
* **gemma4:** refresh the export transcript for the windowed exporter ([a1f943a](https://github.com/labscommunity/cascadia/commit/a1f943a463763922756247998555090c58438c86))
* **gemma4:** serving notes — GPU precision, thinking channel, run command ([9f2e23a](https://github.com/labscommunity/cascadia/commit/9f2e23a54331261836530ae82553ef9c165bd826))
* **gemma4:** the engine does not add BOS on /v1/completions ([cd845cf](https://github.com/labscommunity/cascadia/commit/cd845cf5d96bcee1e04b08ba5a07ebb08942892d))
* **glm:** correct hot/cold comments — overlap scope, mode split, read source ([190db82](https://github.com/labscommunity/cascadia/commit/190db8278b7a3040b3884e60793504891ace4655))
* **glm:** correct prefill-stream comments ([1f0f280](https://github.com/labscommunity/cascadia/commit/1f0f280b0054186dafea19dd6a34553ee323b3b0))
* **glm:** restore save_usage doc misattached to stream_enqueue_layer ([a871ebb](https://github.com/labscommunity/cascadia/commit/a871ebbd8c298c8c0dcb5141d57864510f0a512c))
* Inkling architecture page; list the Rust-shell MoE families ([371a449](https://github.com/labscommunity/cascadia/commit/371a449165dd00a1ffbf46b7c8fd6aeaf92aef38))
* **inkling:** all-iGPU per-layer numbers and the 12-rank projections in the scaling note ([9c7861c](https://github.com/labscommunity/cascadia/commit/9c7861c5f35820489b8cfa8e7de427c8a8890e9b))
* **inkling:** API dialect handling, overlapped reads, rewind bound, exporter direct writes, fixture teeth ([1f0355c](https://github.com/labscommunity/cascadia/commit/1f0355c1735099062c30df8e42c17d7e76f0c00f))
* **inkling:** attention-projection backend and the all-iGPU layer numbers ([abadb02](https://github.com/labscommunity/cascadia/commit/abadb02b5a295952cc33b51874f680b32640a703))
* **inkling:** clarify require_gpu device/IR checks for fused banks ([29a13ce](https://github.com/labscommunity/cascadia/commit/29a13ce224a556c120153a7936a7acbe4b65c062))
* **inkling:** correct expert count, tok/s, de-interleave axis, w13 size ([b4eca06](https://github.com/labscommunity/cascadia/commit/b4eca06092837231b4ac91a1653dac20eed3e514))
* **inkling:** correct lossless-reply nonfinite behavior in the doc ([1d51876](https://github.com/labscommunity/cascadia/commit/1d5187630e7fe0647a960be51e8bc072e6d7a7ca))
* **inkling:** document with_fused flag agreement and fail-loud mismatch ([428d881](https://github.com/labscommunity/cascadia/commit/428d881cf7661497ef44073e0f8d1e7264888c25))
* **inkling:** end-to-end serving with the iGPU backends; the 64 GB rank budget ([02a8e9e](https://github.com/labscommunity/cascadia/commit/02a8e9eb807bf14d61acc5bb15266b2a05c75c9b))
* **inkling:** ep-worker examples need --rank 0 --total 1 ([b398db5](https://github.com/labscommunity/cascadia/commit/b398db553b4f92a0943d72b87519c350af418e90))
* **inkling:** expert cache admits on recency, not frequency alone ([9d2d7b2](https://github.com/labscommunity/cascadia/commit/9d2d7b23d433251faa14681404cf2756e51ba467))
* **inkling:** expert-parallel loopback measurements on the 975B export ([1bd94f5](https://github.com/labscommunity/cascadia/commit/1bd94f507ebba63537e7a8780f12cfe3134e89a5))
* **inkling:** fix non-existent autolab path and reversed attn precision variant ([0bdfb80](https://github.com/labscommunity/cascadia/commit/0bdfb80e1b009472c9d10a2a2008818d92cc948d))
* **inkling:** fix OV attention precision + fused-MoE offload-default comments ([94a1a5e](https://github.com/labscommunity/cascadia/commit/94a1a5eff00614ab428058bd7d25429a8503fa44))
* **inkling:** fix serve/serve_fused doc-comment displacement ([92a5350](https://github.com/labscommunity/cascadia/commit/92a53501fda3d1f07ae211e3472fa8a03207069c))
* **inkling:** fused-MoE backend and the Arc B390 plugin findings ([a20a6b7](https://github.com/labscommunity/cascadia/commit/a20a6b7e419180c1ae48ec687a6cbc5a5ab93de7))
* **inkling:** fused-MoE backend measurements in the engine ([bd68090](https://github.com/labscommunity/cascadia/commit/bd68090d2b16c92c37e82a5d0657e23d6575fb12))
* **inkling:** fused-MoE compile path, offload mode, and shape-cost notes ([4baa690](https://github.com/labscommunity/cascadia/commit/4baa690a7c889f5c96111a1df159857c116c81d9))
* **inkling:** int8 attention as the default; int4 and int8 all-iGPU rows ([649d3e1](https://github.com/labscommunity/cascadia/commit/649d3e1a4194132d046cb12e845fafde60ab6bff))
* **inkling:** minor comment corrections in the read/expert paths ([ab8330b](https://github.com/labscommunity/cascadia/commit/ab8330b74de536c22f918219fb67445f8712f594))
* **inkling:** moe module doc matches copy-only-when-paged-out reads ([659a7c6](https://github.com/labscommunity/cascadia/commit/659a7c67da9816bfb765c5e08580a3c64ee9c112))
* **inkling:** multi-stream decode as the aggregate-throughput follow-up ([fc3b978](https://github.com/labscommunity/cascadia/commit/fc3b97856c30f98ccbc8bfd82621644bf6bd317e))
* **inkling:** note assign assumes a validated placement ([3ea0b1f](https://github.com/labscommunity/cascadia/commit/3ea0b1f2179050b64cb764059b2e6307adc5d264))
* **inkling:** OpenVINO expert backend section ([191bede](https://github.com/labscommunity/cascadia/commit/191bede4376330372b69d4152de57c067231b0f4))
* **inkling:** Panther Lake CPU vs Arc B390 iGPU expert measurements ([d986476](https://github.com/labscommunity/cascadia/commit/d986476c6c363acf16ad09d6a237fc2c4214dbf4))
* **inkling:** rank budget in the scaling note ([20af7d8](https://github.com/labscommunity/cascadia/commit/20af7d8e104699aac3672485aab1f5f3dff6d80e))
* **inkling:** real-model export, layer parity, and end-to-end numbers from the miner ([e3ddbd0](https://github.com/labscommunity/cascadia/commit/e3ddbd0d0b52c5294430ce5a84336b919b6b7c6a))
* **inkling:** record the BF16 tiled dispatch's AVX-512 bit-parity invariant ([f01952f](https://github.com/labscommunity/cascadia/commit/f01952f243d39c83f922ff3be6d30429b938c845))
* **inkling:** resident-regime measurements on the Mac Pro ([d9608fe](https://github.com/labscommunity/cascadia/commit/d9608fe318606a6eaafdd4e2f308717840a6383d))
* **inkling:** resident-set limit of the per-expert IR design on a 64 GB box ([0661b96](https://github.com/labscommunity/cascadia/commit/0661b9669b4b3ef5e0e68a7ca3b11a29c35a879d))
* **inkling:** serving-path check and resident-harness numbers in the single-box bench ([cfb3a9f](https://github.com/labscommunity/cascadia/commit/cfb3a9f1d7fc083608ac59d8f62fd6491ac8685d))
* **inkling:** single-box benchmark results (CPU 1.10 / iGPU 1.24 / OpenVINO-native 0.59 tok/s) ([128c1e8](https://github.com/labscommunity/cascadia/commit/128c1e8939e9a1dc7bcffff3070badce4626d031))
* **inkling:** state and debug-assert map_request's sorted-ids precondition ([22e673b](https://github.com/labscommunity/cascadia/commit/22e673b4ed9b45d7911fdaac71b3f876606b67d2))
* **inkling:** state the by-position OV-attach layer-index precondition ([a0e4c92](https://github.com/labscommunity/cascadia/commit/a0e4c9239847ccec336570581b65d6b138bac9cf))
* **inkling:** the Windows shared-GPU-memory cap sets the rank budget at three fused layers per 64 GB ([422994b](https://github.com/labscommunity/cascadia/commit/422994b28d895de34d80dbbf21903d155b57163f))
* **inkling:** thinking-on end-to-end row (marker translation) and post-review timings ([1adbee4](https://github.com/labscommunity/cascadia/commit/1adbee434798f3e95074b4c92f32dc05b406715a))
* **inkling:** three-fused-layer rank confirmed at the single-layer numbers ([30e7edb](https://github.com/labscommunity/cascadia/commit/30e7edbcdc630468f1c3908b00bd9478a9da27b4))
* **perf:** Inkling fleet scaling note — bytes per token, pipeline vs expert-parallel, what moves tok/s ([96c45c5](https://github.com/labscommunity/cascadia/commit/96c45c52b78ec14ddb4734ba937d8887c3ce4dea))


### Testing

* **gemma4-export:** build rope tables through the existing helper ([68eedce](https://github.com/labscommunity/cascadia/commit/68eedceafcbf9ac83227cdd7075899dce5be8ebc))
* **gemma4-export:** cover the production wrapper and run_export contract ([8dd5018](https://github.com/labscommunity/cascadia/commit/8dd5018bd1e6f0eed4c00d13815d9c5339462fa6))
* **gemma4-export:** cover the single-token, empty-cache mask ([b31d800](https://github.com/labscommunity/cascadia/commit/b31d800548e1ad0677c8fdc58b6d81be4021fc9f))
* **gemma4-export:** let the HF Gemma 4 test fail instead of skipping ([2883e3a](https://github.com/labscommunity/cascadia/commit/2883e3a91d7357098de834da7dd502747dd483ee))
* **gemma4-export:** pin the _verify_stage contract ([fc704ba](https://github.com/labscommunity/cascadia/commit/fc704ba41bd2c504922cb209b232b80277c91062))
* **gemma4-export:** pin the self-verify re-raise in export_single_stage ([4fb68a8](https://github.com/labscommunity/cascadia/commit/4fb68a87a3c0b35160db98ae0182b326f8a79048))
* **gemma4-export:** stop the run_export tests patching openvino process-wide ([ed63bd6](https://github.com/labscommunity/cascadia/commit/ed63bd69f0117941adcbbca63d67812100bbf0cf))
* **gemma4:** cover the stale-tree predicate and the new stage_config fields ([67c58e9](https://github.com/labscommunity/cascadia/commit/67c58e965269a2e494a915a4a377d117966077bd))
* **glm:** assert the hot/cold binaries exercise the intended path ([fb575d9](https://github.com/labscommunity/cascadia/commit/fb575d983a56aa45624831c2e4fb3339cb7871e7))
* **glm:** deterministic coverage of the all-hot fast path ([079790b](https://github.com/labscommunity/cascadia/commit/079790bc179a7e0adcba891c72251c1e9207e032))
* **glm:** extract prefill_stream_gate and table-test the row threshold ([60b9697](https://github.com/labscommunity/cascadia/commit/60b96977262548b57832dec2130395bbc2cd5fbe))
* **glm:** pin cold-read bit-identity and short-read rejection ([094aa38](https://github.com/labscommunity/cascadia/commit/094aa389aded35e41f9004fabfad0019b9945a15))
* **glm:** smoke-test the decode lookahead guard ([f193309](https://github.com/labscommunity/cascadia/commit/f193309cbccd028c928f2b1de8b233cb3f3a1d50))
* **glm:** teacher-forced decode bench mode in glm5_run (--force) ([2ce61f7](https://github.com/labscommunity/cascadia/commit/2ce61f797217a35b1d65ee9ef1ca52c492623605))
* **inkling:** --tolerate-divergence in inkling_decode_bench; single-box bench doc ([164c4a4](https://github.com/labscommunity/cascadia/commit/164c4a4be654643fdcf065b80e9c828dea94898f))
* **inkling:** --warm-ov in inkling_decode_bench compiles OpenVINO backends before timing ([6d96fe0](https://github.com/labscommunity/cascadia/commit/6d96fe06e982e3e0c864be1c394c31803fc85101))
* **inkling:** assert opt-in decode cache/prediction path is bit-identical ([819c087](https://github.com/labscommunity/cascadia/commit/819c087f910a25621dfdba414d74a9d7a1e9ecb1))
* **inkling:** bf16-ULP-aware verdict in the real-weight parity harness ([6b87d8b](https://github.com/labscommunity/cascadia/commit/6b87d8b73520e997f621b3e90b88e943b3eee809))
* **inkling:** cover every FusedShardManifest::validate guard ([d451cfc](https://github.com/labscommunity/cascadia/commit/d451cfca9170df541be9a5a597e6df8dd6d4940c))
* **inkling:** cover the dead-worker reply-timeout and connection drop ([5e50d6e](https://github.com/labscommunity/cascadia/commit/5e50d6e5c8ef1a76de58b333f0be6a60519209b7))
* **inkling:** EP survivor stays frame-aligned when a co-worker fails ([86dcf96](https://github.com/labscommunity/cascadia/commit/86dcf96873f15f8c52db78c3d9156d6a9606e2de))
* **inkling:** fail loudly if the committed EP fixture is missing ([aacf173](https://github.com/labscommunity/cascadia/commit/aacf173f7f0750c9a14669e5997f8fc8d39fd9ae))
* **inkling:** frame alignment holds with two survivors and one failure ([e6540aa](https://github.com/labscommunity/cascadia/commit/e6540aaa6a2e652b86d6bf20e2c8fb6fd0c4fd70))
* **inkling:** gate the shrink-after-open bin test to non-Windows ([88e2f15](https://github.com/labscommunity/cascadia/commit/88e2f152862499d181cbbdfc2f5a86b6fa495d4e))
* **inkling:** loader test actually checks per-position argmax ([1591464](https://github.com/labscommunity/cascadia/commit/15914647afb907afee653b525b3c7ca216497ba1))
* **inkling:** ov_head falls back bit-identically and stays opt-in ([31a0295](https://github.com/labscommunity/cascadia/commit/31a0295023d9e4ec2449f29c06a868f12e57e669))
* **inkling:** real-weight per-layer parity harness (Rust dump + HF comparison) ([5bb74cf](https://github.com/labscommunity/cascadia/commit/5bb74cffef0e7c40f96e01cb7a5ada19366b62f3))
* **inkling:** row-scale verdict for real-weight parity; ULP check optional ([fd19603](https://github.com/labscommunity/cascadia/commit/fd19603ad00dc74b626670c5a31975b6423f1220))
* **inkling:** worker drains a foreign frame, rejects it, and stays aligned ([285bca4](https://github.com/labscommunity/cascadia/commit/285bca40f707d563e5f250cac08091e1cf37d366))
* **tools:** assert Inkling schedule/read escape hatches are bit-identical ([1137c0e](https://github.com/labscommunity/cascadia/commit/1137c0e1243c81809c2229a5feb9e4c193f3ce22))


### CI

* add Linux openvino check for shim and engine ([20ec3f0](https://github.com/labscommunity/cascadia/commit/20ec3f0e5a59a0fb4fe440b9d7ae77731123a2ba))
* add Linux openvino check for shim and engine ([ef78d50](https://github.com/labscommunity/cascadia/commit/ef78d50009a7158aafafbdc04adaf849726697a6))
* **ai-pc:** run cascadia-engine-sparse-moe OV tests on the hardware lane ([b45e80e](https://github.com/labscommunity/cascadia/commit/b45e80e58821fa34e3c28e58a50d889d3621eae3))
* make linux openvino check cover what triggers it ([55234e5](https://github.com/labscommunity/cascadia/commit/55234e59b7444b20d3deac7ba4084da1599c5096))


### Miscellaneous

* **inkling:** move experiment evidence out of the routing PR ([84c0c09](https://github.com/labscommunity/cascadia/commit/84c0c09b4dcca77f200727180c35d0fd5ac81301))
* **sparse-moe:** name the actual family in the pipeline warmup log ([6fc3493](https://github.com/labscommunity/cascadia/commit/6fc34935015961d2e3ff56cdca929ecb034eedfb))
