...
$env_lines = @(
  ...
  "RAYON_NUM_THREADS=$([Environment]::ProcessorCount)", "CASCADIA_INKLING_MAX_SEQ=$(Or $fleet['MAX_SEQ'] 1024)", "CASCADIA_STREAMS=$(Or $fleet['STREAMS'] 16)", "CASCADIA_API_MAX_CONCURRENT=$([int](Or $fleet['STREAMS'] 16) * 4)",
